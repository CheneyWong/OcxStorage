========================================================================
		ActiveX Control DLL : STORAGE
========================================================================

ControlWizard has created this project for your STORAGE ActiveX Control
...
that make up your STORAGE ActiveX Control DLL.
...
StorageCtl.h
	This file contains the declaration of the CStorageCtrl C++ class.

StorageCtl.cpp
	This file contains the implementation of the CStorageCtrl C++ class.

StoragePpg.h
	This file contains the declaration of the CStoragePropPage C++ class.

StoragePpg.cpp
	This file contains the implementation of the CStoragePropPage C++ class.

StorageCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CStorageCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Storage.rc.
